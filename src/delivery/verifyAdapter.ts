...
export function deliveryToVerificationRecord(delivery: Delivery): DeliveryVerificationView {
  ...
  const record: DelegationRecord = {
    ...
    ...(delivery.contract.oracleHash ? { oracleHash: delivery.contract.oracleHash } : {}),
    ...(delivery.contract.executorHashes ? { executorHashes: structuredClone(delivery.contract.executorHashes) } : {}),
    ...(delivery.contract.verifySettings ? { verifySettings: structuredClone(delivery.contract.verifySettings) } : {}),

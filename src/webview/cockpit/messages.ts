...
export interface CockpitStrings {
  ...
  egCanvasLabel: string;
  egTableLabel: string;
  egLoading: string;
  egEmpty: string;
  egNoTelemetry: string;
  egError: string;
  egGroupedNote: string;
  egFilterTurn: string;
  egFilterState: string;
  egFilterKind: string;
  egFilterAgent: string;
  egFilterAll: string;
  egColKind: string;
  egColState: string;
  egColAgents: string;
  egColAttribution: string;
  egColStarted: string;
  egColDuration: string;
  egColExit: string;
  egDetailTitle: string;
  egDetailNone: string;
  egDetailDuration: string;
  egDetailExit: string;
  egDetailCwd: string;
  egDetailWorktree: string;
  egDetailTool: string;
  egDetailIdentity: string;
  egDetailTurn: string;
  egDetailToolCall: string;
  egAttrProven: string;
  egAttrShared: string;

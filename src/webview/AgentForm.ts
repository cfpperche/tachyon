...
function studioStrings(): StudioStrings {
  ...
  return {
    ...
    command: t("Command"),
    commandPhAgent: t("claude · codex · agy · npm run dev"),
    ...
    instructionsHint: t("Delivered as a startup prompt for claude / codex / agy / gemini."),
    ...
    harnessCodex: t("Give this Codex agent its own config, skills, hooks, and MCP"),
    harnessHint: t("Scoped to THIS agent in a private config home — no sibling agent sees them. Put secrets as ${VAR} (resolved from .env / your shell)."),
    harnessCodexHint: t("Scoped to THIS Codex agent in a private CODEX_HOME. Codex uses AGENTS.md for instructions, skills/ for skills, hooks in config.toml, and mcp_servers for MCP."),
    ...
    harnessInstructionsLabel: t("Instruction files — one path per line"),
    harnessInstructionsPh: t("agents/researcher.md"),

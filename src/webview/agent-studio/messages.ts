...
export interface StudioStrings {
  ...
  harnessMcpLabel: string; harnessMcpPh: string; harnessRulesLabel: string; harnessRulesPh: string; harnessInstructionsLabel: string; harnessInstructionsPh: string;

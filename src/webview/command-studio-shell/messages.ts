...
import type { CommandStudioPatch } from "./domain";

/** t-610705 (Phase D, D0) — routeKey/mountNonce identify WHICH Control-hosted binding this ready is
...
export const patchMessage = (patch: CommandStudioPatch, editRevision?: number) =>

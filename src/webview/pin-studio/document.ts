...
export function attachmentsUsedByDoc(doc: TiptapJSON, attachments: PinStudioAttachmentVM[]): PinStudioAttachmentVM[] {
...
export function attachmentsForSave(doc: TiptapJSON, attachments: PinStudioAttachmentVM[]): PinStudioAttachmentVM[] {
...
export function upsertAttachment(attachments: PinStudioAttachmentVM[], attachment: PinStudioAttachmentVM): PinStudioAttachmentVM[] {

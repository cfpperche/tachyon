 ...
 */
const WEBVIEW_APP_VIEWS = ["cockpit", "section-app-fixture", "task-detail", "pin-preview", "command-studio-shell", "terminal-studio-shell", "runbook-studio-shell", "schedule-studio-shell", "agent-studio-shell", "mission-control", "inspector", "plugins", "runtime-ops", "runtime-config", "human-inbox", "engine", "worktrees", "fleet", "execution-graph", "settings", "overview"];
const webviewApps = {
  ...sidebar,

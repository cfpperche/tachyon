...
// shared/ui/ to fall back to — DropdownMenu is a wholly NEW capability here, same posture as KitDialog.
// If a future Radix bump regresses this component, there is

 ...
 * CSS rule (`.ds-btn .codicon` / `.ds-tab .codicon` / `.ds-chip .codicon` / `.ds-badge .codicon` in
 * design-system.css), NOT here — the component is the distribution mechanism, the CSS is the alignment fix.
 */

...
// t-a65335 — CONFIG_FILENAMES retired: the workspace config is .tachyon/settings.yml (see
// workspaceSettingsFile.ts). t-987825 removed the one-shot migration that read the legacy root
// filenames, so nothing in the product names them any more.

 ...
 * The Preact UI renders ONLY from these types. Preview/test fixtures live next to the
 * preview entry (`scripts/webview-preview/fixtures/sidebar.ts`); this file is types only.
 */

 ...
 *   2. what does the bundle budget measure. The budget numbers themselves live next to
 *      `webviewAppBudget.test.ts` — not on these rows — so they do not ship in the extension host.
 *      The test still walks THIS list; a new app without a budget key fails typecheck.
 *
...
const WEBVIEW_APP_ROWS = [
  ...
  { view: "section-app-fixture", viewId: "tachyonSectionAppFixture", host: "section", cardinality: "document" },
  ...
  { view: "task-detail", viewId: "tachyonTaskDetail", host: "section", cardinality: "document" },
  // SDD 485 D14 — one Pins document app per (project, pin). Read and edit are modes of this key.
  { view: "pin-preview", viewId: "tachyonPinPreview", host: "section", cardinality: "document" },
  // D13 — editing-only documents. "new" is the provisional creation identity; saved entities use their id.
  { view: "terminal-studio-shell", viewId: "tachyonTerminalStudioShell", host: "section", cardinality: "document" },
  { view: "schedule-studio-shell", viewId: "tachyonScheduleStudioShell", host: "section", cardinality: "document" },
  { view: "agent-studio-shell", viewId: "tachyonAgentStudioShell", host: "section", cardinality: "document" },
  ...
  { view: "board", viewId: "tachyonBoard", section: "mission", host: "section", cardinality: "dashboard" },
  ...
  { view: "inspector", viewId: "tachyonServerInspector", section: "tmux", host: "section", cardinality: "window" },
  ...
  { view: "plugins", viewId: "tachyonPlugins", section: "plugins", host: "section", cardinality: "dashboard" },
  ...
  { view: "runtime-ops", viewId: "tachyonRuntimeOps", section: "runtime", host: "section", cardinality: "window" },
  ...
  { view: "runtime-config", viewId: "tachyonRuntimeConfig", section: "runtime-config", host: "section", cardinality: "dashboard" },
  ...
  { view: "human-inbox", viewId: "tachyonHumanInbox", section: "inbox", host: "section", cardinality: "dashboard" },
  { view: "handoff", viewId: "tachyonHandoff", host: "section", cardinality: "dashboard" },
  ...
  { view: "system", viewId: "tachyonSystem", section: "system", host: "section", cardinality: "dashboard" },
  ...
  { view: "settings", viewId: "tachyonSettings", section: "settings", host: "section", cardinality: "dashboard" },
  { view: "companion", viewId: "tachyonCompanion", section: "companion", host: "section", cardinality: "dashboard" },
  ...
  { view: "activity", viewId: "tachyonActivity", host: "section", cardinality: "document" },
  // SDD 513 fatia 3 — worktree review as a document: one tab per (project, worktree), revealed
  // rather than duplicated. No launcher tile; the review command is the only open door.
  { view: "review", viewId: "tachyonReview", host: "section", cardinality: "document" },
  ...
  { view: "probes", viewId: "tachyonProbes", host: "section", cardinality: "document" },
] as const satisfies readonly WebviewAppEntry[];

/** Shipped manifest — widened so optional fields stay optional for every consumer. */
export const WEBVIEW_APPS: readonly WebviewAppEntry[] = WEBVIEW_APP_ROWS;

/** Literal app names from the manifest — the budget table is indexed by this union. */
export type WebviewAppName = (typeof WEBVIEW_APP_ROWS)[number]["view"];

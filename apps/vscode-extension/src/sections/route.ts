import type { CockpitSectionRoute, CockpitTaskDetailRoute, CockpitAgentActivityRoute, CockpitAgentProbesRoute, CockpitWorkspaceProbesRoute, CockpitProjectHandoffRoute, CockpitInboxItemRoute, CockpitNonStudioRoute, CockpitStudioNewRoute, CockpitStudioEditRoute, ProductRoute, CockpitRefreshPolicy, CockpitPanelStateV1, CockpitPanelStateV2, CockpitPanelState } from "@tachyon/webview-ui/sections/route";
export type { CockpitSectionRoute, CockpitTaskDetailRoute, CockpitAgentActivityRoute, CockpitAgentProbesRoute, CockpitWorkspaceProbesRoute, CockpitProjectHandoffRoute, CockpitInboxItemRoute, CockpitNonStudioRoute, CockpitStudioNewRoute, CockpitStudioEditRoute, ProductRoute, CockpitRefreshPolicy, CockpitPanelStateV1, CockpitPanelStateV2, CockpitPanelState } from "@tachyon/webview-ui/sections/route";
/**
...
import { isStudioId, type StudioId } from "../webview/shared/studio/studioIds";

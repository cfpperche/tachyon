...
const TOKENS = "/dist/webview/tokens.css";
const FACES = "/dist/webview/faces.css";
const DESIGN_SYSTEM = "/dist/webview/design-system.css";
const QUICK_PICKER = "/dist/webview/quick-picker.css";
const BASE_STYLESHEETS = [CODICON, TOKENS, FACES, DESIGN_SYSTEM, QUICK_PICKER] as const;

export const ROUTES: Record<string, Route> = {
  sidebar: {
    bundle: "/dist/webview/sidebar.js",
    cssLinks: [...BASE_STYLESHEETS, "/dist/webview/sidebar.css"],
    frame: { w: 340, h: 760 },
  ...
  probes: {
    ...
    cssLinks: [...BASE_STYLESHEETS, "/dist/webview/probes.css"],
    frame: { w: 880, h: 900 },
  ...
  "agent-studio-shell": {
    ...
    module: true,
    cssLinks: [...BASE_STYLESHEETS, "/dist/webview/vscode-theme.css", "/dist/webview/agent-studio-shell.tailwind.css", "/dist/webview/studio-frame.css", "/dist/webview/agent-studio-shell.css"],
    frame: { w: 900, h: 900 },
  ...
  "terminal-studio-shell": {
    ...
    module: true,
    cssLinks: [...BASE_STYLESHEETS, "/dist/webview/vscode-theme.css", "/dist/webview/studio-frame.css", "/dist/webview/terminal-studio-shell.css"],
    frame: { w: 900, h: 760 },
  ...
  "schedule-studio-shell": {
    ...
    module: true,
    cssLinks: [...BASE_STYLESHEETS, "/dist/webview/vscode-theme.css", "/dist/webview/studio-frame.css", "/dist/webview/schedule-studio-shell.css"],
    frame: { w: 760, h: 760 },
  ...
  "task-detail": {
    ...
    cssLinks: [
      ...BASE_STYLESHEETS, "/dist/webview/vscode-theme.css", "/dist/webview/task-studio.tailwind.css",
  ...
  inspector: {
    ...
    cssLinks: [...BASE_STYLESHEETS, "/dist/webview/inspector.css"],
    frame: { w: 880, h: 900 },
  ...
  plugins: {
    ...
    cssLinks: [...BASE_STYLESHEETS, "/dist/webview/plugins.tailwind.css", "/dist/webview/plugins.css"],
    frame: { w: 880, h: 900 },
  ...
  "human-inbox": {
    ...
    cssLinks: [...BASE_STYLESHEETS, "/dist/webview/human-inbox.css"],
    frame: { w: 880, h: 900 },
  ...
  "runtime-ops": {
    ...
    cssLinks: [...BASE_STYLESHEETS, "/dist/webview/runtime-ops.css"],
    frame: { w: 880, h: 900 },
  ...
  "runtime-config": {
    ...
    cssLinks: [...BASE_STYLESHEETS, "/dist/webview/runtime-config.css"],
    frame: { w: 880, h: 900 },
  ...
  worktrees: {
    ...
    cssLinks: [...BASE_STYLESHEETS, "/dist/webview/control-typography.css", "/dist/webview/engine-workspace.css", "/dist/webview/worktrees.css"],
    frame: { w: 880, h: 900 },
  ...
  keys: {
    bundle: "/dist/webview/keys.js",
    cssLinks: [...BASE_STYLESHEETS, "/dist/webview/keys.css"],
    frame: { w: 880, h: 900 },
    fixtures: keysFixtures,
    module: true,
  ...
  system: {
    ...
    cssLinks: [...BASE_STYLESHEETS, "/dist/webview/engine-workspace.css", "/dist/webview/system.css"],
    frame: { w: 880, h: 900 },
    fixtures: {
  ...
  handoff: {
    ...
    cssLinks: [...BASE_STYLESHEETS, "/dist/webview/mermaid-block.css", "/dist/webview/activity.css", "/dist/webview/handoff.css"],
    frame: { w: 880, h: 900 },
  ...
  review: {
    ...
    pageFrame: true,
    globals: {
      PDFJS_WORKER_URI: "/dist/webview/pdf.worker.min.mjs",
      PDFJS_VIEWER_URI: "/dist/webview/review-pdf.js",
      MODEL_VIEWER_URI: "/dist/webview/review-model-viewer.js",
    },
  ...
  "section-app-fixture": {
    ...
    cssLinks: [...BASE_STYLESHEETS, "/dist/webview/section-app-fixture.css"],
    frame: { w: 880, h: 520 },

...
export const strings: CockpitStrings & WorktreesStrings = {
  ...
  settingsWritesTo: "Writes to",
  settingsWritesToEither: "Writes to either — you pick below",
  settingsWritesToNothing: "Reads only",
  companionTitle: "Companion",
  companionHint: "Pair devices, manage access, and keep trusted connections in view.",
  ...
  landIntro: "Land fast-forwards the trunk onto this delivery, in the primary checkout. It never lands on its own.",
  landCommandLabel: "Land command",
  landCopyCommand: "Copy command",
  landBlocked: "Not ready to land — {0} precondition(s) not proved. No command is offered.",
    ...
    worktrees: [
      {
        ...
        kind: "change",
        path: "/cache/wt/b349073a/change/in-flight",
        branch: "tachyon/change/in-flight",
        status: "active",
        slug: "in-flight",
        folder: "tachyon",
        wsHash: "b349073a",
      ...
      {
        id: "mw-change-create-failed",
        kind: "change",
        path: "/cache/wt/b349073a/change/bad-base",
        branch: "tachyon/change/bad-base",
        status: "active",
        slug: "bad-base",
        folder: "tachyon",
        wsHash: "b349073a",
        tachyonCreatedBranch: true,
        create: { phase: "resolve-base", error: "cannot resolve base ref 'no-such-ref'" },
      },
      {
        id: "mw-change-ready",
        kind: "change",
      ...
      // roster and no ledger. It renders WITH the removal control (Forget cannot reach it by name),
      // and says why, next to a sibling agent row that keeps the read-only treatment.
      {
        id: "mw-agent-orphan",
        kind: "agent",
        path: "/cache/wt/b349073a/orfaozinho",
        branch: "tachyon/orfaozinho",
        status: "active",
        agent: "orfaozinho",
        folder: "tachyon",
        wsHash: "b349073a",

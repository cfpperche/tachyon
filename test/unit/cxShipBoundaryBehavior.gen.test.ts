...
describe("container-generated delegation behavior", () => {
  it("the packaged extension ships only allowlisted files: no dev harness, no fixtures, no source maps", async () => {
    ...
    const inventory = {
      ...
      "dist/webview/ui-gate.js": "dev-artifact",
      "dist/webview/ui-gate.tailwind.css": "dev-artifact",
      "dist/webview/section-app-fixture.js": "dev-artifact",
      "dist/webview/section-app-fixture.css": "dev-artifact",

...
describe("spec 377 T14 soul enablement in Agent Studio", () => {
  it("defaults off and round-trips only soul: true through the authoritative form/save shape", () => {
    ...
    expect(computeAgentDirty({ fields: enabled, chips: [], flagMap: {}, defaultCwd: "", verifyCandidates: [], evolutionLabels: createAgentEvolutionLabels() }, { ...enabled, soul: false })).toBe(true);

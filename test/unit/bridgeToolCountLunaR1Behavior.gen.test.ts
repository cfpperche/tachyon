...
describe("container-generated delegation behavior", () => {
  it("exposes exactly the 78 tools", () => {
    ...
    // (spec 493, the durable read door onto .tachyon/doorbells.jsonl).
    expect(bridgeTest).toContain('it("exposes exactly the 78 canonical tools');

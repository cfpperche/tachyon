...
describe("container-generated delegation behavior", () => {
  it("exposes exactly the 82 tools", () => {
    ...
    // t-6b3a0d added authenticated native runtime lifecycle ingest.
    expect(bridgeTest).toContain('it("exposes exactly the 82 canonical tools');

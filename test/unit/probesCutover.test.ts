...
describe("SDD 485 D18 — Probes cutover doors and renderer inventory", () => {
  ...
  it("the standalone root consumes shared page chrome", () => {
    expect(read("packages/webview-ui/src/webview/probes/main.tsx")).toContain('class="ds-page"');
    expect(read("apps/vscode-extension/src/webview/ProbeResultPanel.ts")).toContain('"design-system.css"');
  });
});

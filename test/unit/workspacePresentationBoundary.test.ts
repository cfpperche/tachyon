...
describe("persistent workspace presentation boundary", () => {
  ...
  it("keeps the runtime projection and deterministic client fake editor-free", () => {
    for (const relative of [
      "packages/engine/src/activity/attributionGap.ts",
      "packages/engine/src/agents/agentInputService.ts",
      ...
      "packages/engine/src/runtime-api/boardCommands.ts",
      "packages/engine/src/runtime-api/boardProjection.ts",
      "packages/engine/src/runtime-api/sidebarCommands.ts",
      "packages/engine/src/runtime-api/sidebarProjection.ts",
      "packages/engine/src/runtime-api/pinStudioCommands.ts",
      "packages/engine/src/runtime-api/pinStudioProjection.ts",
      "packages/engine/src/runtime-api/richDocWire.ts",
      "packages/engine/src/runtime-api/taskDetailCommands.ts",
      "packages/engine/src/runtime-api/taskDetailProjection.ts",

...
import { reduceDetailStale, INITIAL_STALE_STATE, selectedReviewablePrototype, type DetailStaleState } from "@tachyon/webview-ui/webview/task-detail/interactions.js";
import type { TaskPrototypeListVM, TaskPrototypeVM } from "@tachyon/webview-ui/webview/task-prototype/types.js";

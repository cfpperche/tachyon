 ...
 */
import { SAMPLE, type AgentVM } from "../../../src/sidebar/types.js";
...
export const AGENT_CARD_FIXTURES: readonly AgentCardFixture[] = [
  ...
  { name: "badge-verify-pass", props: { a: agent({ name: "v-pass", verify: "pass" }), flash: false } },
  { name: "badge-verify-fail", props: { a: agent({ name: "v-fail", verify: "fail" }), flash: false } },
  { name: "badge-verify-stale", props: { a: agent({ name: "v-stale", verify: "stale" }), flash: false } },

...
- [ ] Slice A: establish typed runtime-config inventory/read boundary and replace static prototype
...
- [ ] Global/workspace provenance and individual tooling inventory are rendered from real source

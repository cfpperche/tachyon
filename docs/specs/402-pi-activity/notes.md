...
- SDD 400/401 already makes `AgentManager.transcriptPathOf` return the exact Pi file and session ID from the private home. No Activity-specific directory scan was added.
...
- Full suite: 4,873 passed, 3 skipped, with only the two inherited baseline failures from SDD 399–401:

...
(517 files, 5789 tests), `node scripts/dogfood/run.mjs claude-bypass-optin` (5/5), and the Visual QA screenshots
...
**Dogfood:** `node scripts/dogfood/run.mjs claude-bypass-optin`

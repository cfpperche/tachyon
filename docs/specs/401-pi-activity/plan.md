...
- Pi `docs/session-format.md`, shipped session manager/types, and real SDD 399/400 RPC transcripts.
- `src/activity/{types,claudeNormalizer,grokNormalizer,logWriter,ActivityLogManager}.ts` and their unit/integration suites.
- SDD 238/239 Activity contracts, SDD 378 model provenance, SDD 399 exact Pi resolution, SDD 400 private homes.

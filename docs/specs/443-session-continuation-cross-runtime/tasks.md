...
**Verify:** `npx vitest run test/unit/cmdRuntimeGate.test.ts test/unit/sessionContinuation.test.ts`

- [x] Cmd runtime gate pure module + unit tests (`t-6d09e6`)
- [x] Studio submit refuse when live + clearResume when stopped

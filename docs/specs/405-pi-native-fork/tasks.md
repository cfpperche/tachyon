...
**Human dogfood:** ✓ Isolated Dev Host at `397cea17`: Pi A stored `COBALT-405-FORK`; Tachyon Fork created B with inherited context and distinct home/UUID; Stop→Resume of both independently retained the codeword.

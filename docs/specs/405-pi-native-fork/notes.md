...
- Full suite: 4,892 passed, 3 skipped, with only the inherited baseline failures retained from SDD 399–404:
...
- Target: isolated SDD 405 fixture, worktree build `397cea17`, 2026-07-18.
- `pi-a` UUID `5ad5f124-e7ca-4e43-bf00-fa06bb0cc9a8` established codeword `COBALT-405-FORK`.

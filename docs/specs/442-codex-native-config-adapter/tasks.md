...
- [x] Slice C: tooling composition is split by trust boundary: private composition of existing
...
- [x] Slice D: lifecycle dogfood and per-family parity evidence.
...
- [x] Fresh/restart/resume regenerate equivalent projection.
...
**Human dogfood:** optional follow-up: create a new canonical Codex agent with explicit selectors and compare fresh/restart/resume behavior in the installed extension. The shipped acceptance proof is automated because it must cover deliberate private-home tampering between all three lifecycle launches.

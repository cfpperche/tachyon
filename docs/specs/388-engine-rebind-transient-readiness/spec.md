...
**Status:** in-progress
**Affected Product Invariants:** none — the only registered invariant covers project-guidance ownership,
not persistent-engine client recovery.
...
- [ ] **Scenario: transient readiness recovers the same session**
...
- [ ] **Scenario: retry timeout preserves the survivor**
...
- [ ] **Scenario: permanent generic-resume denial fails immediately and safely**
...
- [ ] **Scenario: recovery probes do not weaken the normal readiness cache**
...
- [ ] **Scenario: shell reload remains operationally inert**
...
- [ ] Existing queue ordering, circuit breaker, post-resume stability proof, no-cold-spawn rule, and

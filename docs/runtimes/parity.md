...
**Evidence:** `test/unit/agentRuntimeAdmission.test.ts` (31 cases — admission, launcher resolution,
refusal text, the declaration-vs-code agreement, and both directions of the attested relation); door
cases in `test/unit/bridge.test.ts` and `test/unit/agentManager.test.ts`; and
